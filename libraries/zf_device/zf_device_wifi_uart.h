...
#define WIFI_UART_TX_PIN (UART3_RX_P17_1) // 连接 WIFI 模块 TX
#define WIFI_UART_RX_PIN (UART3_TX_P17_2) // 连接 WIFI 模块 RX
#define WIFI_UART_RTS_PIN (P20_0)         // 定义流控位引脚  指示当前模块是否可以接受数据  0-可以继续接收  1-不可以继续接收
...
#define WIFI_UART_RST_PIN (P19_3)         // 定义硬件复位引脚
#endif
//==============================================定义 WIFI_UART 基本配置===================================================
