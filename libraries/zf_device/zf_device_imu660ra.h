...
#define IMU660RA_SPC_PIN              (SPI0_CLK_P02_2  )                        // 硬件 SPI SCK 引脚
#define IMU660RA_SDI_PIN              (SPI0_MOSI_P02_1 )                        // 硬件 SPI MOSI 引脚
#define IMU660RA_SDO_PIN              (SPI0_MISO_P02_0 )                        // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
#define IMU660RA_CS_PIN               (P02_3)                                   // CS 片选引脚
